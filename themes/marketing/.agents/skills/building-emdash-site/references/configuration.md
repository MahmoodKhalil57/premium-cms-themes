...
import emdash, { local } from "@premium-cms/emdash/astro";
...
For Cloudflare, replace `@astrojs/node` with `@astrojs/cloudflare` and add `@premium-cms/cloudflare`.
